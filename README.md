...
* Relational Databases
	* [cx_Oracle] (http://cx-oracle.readthedocs.org/en/latest/index.html) - cx_Oracle is a Python extension module that enables access to Oracle 10G, 11G and 12C databases
